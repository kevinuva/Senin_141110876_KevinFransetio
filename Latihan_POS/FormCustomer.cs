...
namespace Pertemuan11_a
{
    public partial class FormCustomer : Form
    {
        ...
        {
            string mysql = String.Concat("Insert Into customer(name,address,zip_code,phone_number,email) values('", txName.Text, "', '", txAddress.Text, "', '", txZipCode.Text, "','" , txPhoneNumber.Text, "','",txEmail.Text, "')");
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                mysql = String.Concat("Delete From customer Where id = '", txId.Text, "'");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (hsl == DialogResult.Yes)
            {
                mysql = String.Concat("DELETE FROM customer");
                MySqlCommand cmd = new MySqlCommand(mysql, conn);
